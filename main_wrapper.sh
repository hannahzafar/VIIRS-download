...
./main.py -p VNP43IA4 -v 002 -gs VNP43IA4.A2020001.*.002.* -s 2020-01-01 -e 2020-01-01
# ./viirs_download.py -p VNP43IA4 -v 002 -gs VNP43IA4.A2020001.*.002.* -s 2020-01-01 -e 2020-01-01

# Test with granule-string wildcard
# ./viirs_download.py -p VNP43IA4 -v 002 -gs VNP43IA4.A2020001.*.002.* -s 2020-01-01 -e 2020-01-01
